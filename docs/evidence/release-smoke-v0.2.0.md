...
- This proves checksum-verifiable Windows archive execution. It predates GitHub artifact attestation verification and does not prove code-signed binaries or package-manager installation.
